...
def patch_forward_with_backends(
    ...
    """Fused forward kernels are outside this text-only release."""
    if use_fused_kernels:
        raise ValueError("Set actor_rollout_ref.model.use_fused_kernels=False for this release")
...
def apply_monkey_patch(
    ...
    if model.config.model_type in ["qwen2_5_vl", "qwen2_vl"]:
        ...
        raise ValueError("GLM4V is not included in this text-only release")
